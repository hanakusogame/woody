...
var Config = /** @class */ (function (_super) {
    ...
    function Config(scene, x, y) {
        ...
        var colors = ["#303030", "gray", "black", "white", "green", "navy"];
        var colorNum = 0;
        //背景色
        base.append(new g.Label({
            scene: scene,
        ...
        var sprColor = new g.FilledRect({ scene: scene, x: 132, y: 152, width: 106, height: 36, cssColor: colors[colorNum], touchable: true });
